...
<body>
    ...
    <section id="wrapper" class="login-register login-sidebar"  style="background-image:url({{ asset('materialpro') }}/assets/images/background/login-register.jpg);">
          ...
          <form class="form-horizontal form-material" id="loginform" action="index.html">
            ...
            <div class="form-group m-b-0">
              <div class="col-sm-12 text-center">
                <p>Don't have an account? <a href="{{ asset('materialpro') }}/register2.html" class="text-primary m-l-5"><b>Sign Up</b></a></p>
              </div>
            </div>
          </form>

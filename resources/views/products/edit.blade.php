    ...
    <fieldset disabled>
        <div class="row">
            <div class="form-group col-md-6">
                ...
                <input name="created_by" value="{{ $products->createdBy['name'] }}" type="text"
                    class="form-control form-control-line" id="created_by">
                <small>{{ $products->created_at }}</small>
            </div>
            <div class="form-group col-md-6">
                <label>Updated By</label>
                <input name="updated_by" value="{{ $products->updatedBy['name'] }}" type="text" class="form-control"
                    id="updated_by">

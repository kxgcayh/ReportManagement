        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="index.html">
                ...
                <b>
                    ...
                    {{-- Dark Logo icon  --}}
                    <img src="{{ asset('materialpro') }}/assets/images/logo-icon.png" alt="homepage"
                        class="dark-logo" />
                    {{-- Light Logo icon  --}}
                    <img src="{{ asset('materialpro') }}/assets/images/logo-light-icon.png" alt="homepage"
                        class="light-logo" />
                </b>
                {{-- End Logo icon  --}}
                {{-- Logo text  --}}
                        ...
                        <ul class="dropdown-user">
                            ...
                            <li>
                                <a href="{{ route('register') }}"> <i
                                        class="mdi mdi-account-plus"></i>{{__(' Register') }}</a>
                            </li>
                            @endif
                        </ul>
                    </div>
